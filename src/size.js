...
import { insertSize } from './Api/common.api';
...
export default function Size() {
  ...
  const submitSize = async () => { 
    if (inputSize.length == 0) {
      ...
      console.log(".....")
      const response = await insertSize(inputSize);
  ...
  <div className="container-fluid" id="container-wrapper">
    <div className="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 className="h3 mb-0 text-gray-800">size</h1>
      ...
      <div className="col-lg-6">
        ...
        <div className="card mb-4">
          <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 className="m-0 font-weight-bold text-primary">size</h6>
          </div>
          <div className="card-body">
            <form>
              ...
              <button type="button" className="btn btn-primary" onClick={(e)=> submitSize(e)}>
                Submit
              </button>
            </form>
          </div>
