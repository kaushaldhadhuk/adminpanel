...
import {insertSubCategory, getCategory } from './Api/common.api';
...
export default function Subcategory() {
    ...
    const insertSubCategoryFunction = async () => {

      const response = await insertSubCategory(subcategory);
  ...
  <div className="container-fluid" id="container-wrapper">
    <div className="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 className="h3 mb-0 text-gray-800">subcategory</h1>
      ...
      <div className="col-lg-6">
        ...
        <div className="card mb-4">
          <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
            <h6 className="m-0 font-weight-bold text-primary">subcategory</h6>
          </div>
          <div className="card-body">
            <form>
              ...
              <button type="button" className="btn btn-primary" onClick={(e)=>insertSubCategoryFunction(e)}>
                Submit
              </button>
            </form>
          </div>
